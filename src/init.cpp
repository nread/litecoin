...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/playeronecoin-project/playeronecoin>";
    const std::string URL_WEBSITE = "<https://playeronecoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("PlayerOnecoin version %s\n", FormatFullVersion());
}
