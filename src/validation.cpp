...
#if defined(NDEBUG)
# error "PlayerOnecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "PlayerOnecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PONE additional fees, %d delta bytes\n",
