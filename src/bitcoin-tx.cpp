...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s playeronecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  playeronecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded playeronecoin transaction") + "\n" +
              "  playeronecoin-tx [options] -create [commands]   " + _("Create hex-encoded playeronecoin transaction") + "\n" +
              "\n";
